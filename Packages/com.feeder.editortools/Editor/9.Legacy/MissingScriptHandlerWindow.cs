...
namespace Feeder {
    public class MissingScriptHandlerWindow : OdinEditorWindow
    {
        [MenuItem("Tools/Feeder/Legacy/Missing Script Handler Window")]
        private static void OpenWindow()
        {
            GetWindow<MissingScriptHandlerWindow>("Missing Script Handler Window").Show();
        }
